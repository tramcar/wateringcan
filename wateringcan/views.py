...
def index(request):
    ...
    return render(request, "wateringcan/index.html", {"page": page, "content_md": content_md})
...
def detail(request, page_id):
    ...
    # TODO: Sanitize markdown
    content_md = markdown.markdown(page.content)
    return render(request, "wateringcan/detail.html", {"page": page, "content_md": content_md})
